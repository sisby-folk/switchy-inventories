...
public class EnderChestCompat implements PresetModule {
	...
	static {
		PresetModuleRegistry.registerModule(ID, EnderChestCompat::new, false, ModuleImportable.OPERATOR, Set.of(), Text.translatable("commands.switchy_inventories.module.warn.inventories"));
	}
}
